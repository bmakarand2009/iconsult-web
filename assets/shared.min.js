...
/******** start of sevices.js******/
myApp.factory("RestMaster", [ "$resource", "$location", "$state", "$timeout", "$cookieStore", "appConstants", function($resource, $location, $state, $timeout, $cookieStore, appConstants) {
...
/* LIST SUPPLIERS PAGE */
myApp.controller("RecListController", [ "$scope", "$location", "$timeout", "RestMaster", "entDetails", function($scope, $location, $timeout, RestMaster, entDetails) {
    $scope.init = function() {
...
/*   VIEW CONTROLLER */
myApp.controller("RecViewController", [ "$scope", "$stateParams", "RestMaster", "entDetails", function($scope, $stateParams, RestMaster, entDetails) {
    $scope.record;
    if (!$scope.record) {
...
myApp.controller("ListServerPagingCtrl", [ "$scope", "$location", "$timeout", "RestMaster", "entDetails", "$http", "$compile", function($scope, $location, $timeout, RestMaster, entDetails, $http, $compile) {
...
myApp.controller("ListClientPagingCtrl", [ "$scope", "$location", "$timeout", "RestMaster", "entDetails", "tableDataService", "$http", "$compile", "createDialog", "genericModules", function($scope, $location, $timeout, RestMaster, entDetails, tableDataService, $http, $compile, createDialog, genericModules) {
    $scope.selectedItems = [];
    $scope.checkedRows = [];
...
}).value("toastr", window.toastr).value("routerStates", {
    home: "home",
