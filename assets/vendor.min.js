...
// AddNewRecords.js 
myApp.controller("VendorAddController", [ "$scope", "$stateParams", "RestMaster", "entDetails", "sharedService", "$cookieStore", function($scope, $stateParams, RestMaster, entDetails, sharedService, $cookieStore) {
    $scope.types;
    $scope.vendor = {
        name: "",
        address: "",
